...
public class Inventory extends Script {
    ...
    @Override
    public void update() {
        if (this.player != null && type.equals(InventoryType.LOOT)) {
        ...
        } else if (player != null && type.equals(InventoryType.PLAYER)) {
            int mx = (int) MouseInput.x, my = (int) MouseInput.y;
            if ((mx / 64) - 9 >= 0 && (mx / 64) - 9 <= 3 && (my / 64) - 3 >= 0 && (my / 64) - 3 <= 2 && MouseInput.isPressed && !held) {
                held = true;
                if (holding == null && player.player.getInventory().items[(my / 64) - 3][(mx / 64) - 9] != null) {
                    holding = player.player.getInventory().items[(my / 64) - 3][(mx / 64) - 9];
                    player.player.getInventory().items[(my / 64) - 3][(mx / 64) - 9] = null;
    ...
    public void lateRender() {
        if (player != null) {
            if (type.equals(InventoryType.LOOT)) {
                ...
                Draw.setFill(Color.color(0, 0, 0, 0.3));
                Draw.rect(64 * 9, 64 * 3, 64 * 12, 64 * 3, true);
                int y = 0;
                for (Item[] itemL : items) {
                    int x = 0;
                    for (Item item : itemL) {
